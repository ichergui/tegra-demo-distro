...
**NOTE** that this is a **work-in-progress** branch for testing L4T R36.3.0/JetPack 6 GA.
It is not suitable for production use.

![Build status](https://builder.madison.systems/badges/tegrademo-wip-36-3-0.svg)
...
| meta-tegra            | wip-l4t-r36.3.0-dp  | L4T BSP layer - L4T R36.3.0/JetPack 6.0 GA          |
| meta-tegra-community  | wip-l4t-r36.3.0-dp  | OE4T layer with additions from the community        |
