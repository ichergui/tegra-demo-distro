...
SRC_URI = "https://github.com/madisongh/tegra-sysinstall/releases/download/v${PV}/tegra-sysinstall-${PV}.tar.gz \
           ...
           file://0003-lib-tools-common.in-keystoretool-nvluks-srv-app.patch \
           file://0004-lib-tools-common.in-align-cryptsetup-args-with-NVidi.patch \
...
EXTRA_RDEPENDS:cryptparts = "cryptsetup optee-nvsamples-luks-srv"
